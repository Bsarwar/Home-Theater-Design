...
const services = [
  ...
  },
  {
    ...
    features: ["Architectural & spatial planning", "Acoustic room modeling & simulation", "Design & 3D Rendering", "Seating layout & sightline analysis", "Equipment specification & scheduling", "Lighting and electrical design"],
