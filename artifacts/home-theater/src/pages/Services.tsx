...
const services = [
  ...
  },
  {
    ...
    features: ["Custom fiber optic star panels", "Adjustable star density & placement", "Shooting star & twinkle effects", "App Controlled RGB color options", "Integrated with lighting control systems", "Available in flat, coffered & vaulted configurations", "Biggest WOW factor — kids are amazed"],
