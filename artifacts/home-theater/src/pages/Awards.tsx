...
import theater1Img from "@assets/ML2_1781625828357.jpg";
...
const awards = [
  ...
  },
  {
    ...
    year: "2022",
    description: "A small, odd-shaped unfinished basement became our pet project — proof that nearly any space can function as a world-class home theater when the right design and integration practices are applied. Our clients had relocated to be closer to their kids and future grandkids, and wanted a comfortable space the whole family could share. We developed an earth-tone color scheme and custom star ceiling that makes the room feel open and airy far beyond its footprint. Fabric-wrapped trim panels conceal the in-wall Triad speakers throughout, and two JL Audio subwoofers were tucked into an adjacent room to preserve seating space. We decoupled the walls for sound isolation, then teamed with Custom Works AV to complete the full Dolby Atmos integration.",
    highlights: ["Sony 4K projector · Screen Innovations Zero Edge screen", "Full Dolby Atmos surround — zero visible speakers", "Two JL Audio subwoofers in adjacent room", "Fabric trim panels concealing in-wall Triad speakers", "Decoupled walls for sound isolation", "AV integration by Custom Works AV · URC controls"],
    awardOrg: "CE Pro",
    awardCategory: "Home of the Year — Silver Winner",
    badgeColor: "silver" as const,
    publication: "CE Pro Magazine",
