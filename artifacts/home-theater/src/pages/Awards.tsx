...
const awards = [
  ...
  },
  {
    ...
    year: "2022",
    description: "Not every great theater starts with a grand canvas. This project began as a small, odd-shaped unfinished basement — a space that required ample creativity to transform into something extraordinary. Our clients had relocated to be closer to their kids and future grandkids, and wanted a room the whole family could enjoy. Working closely with them, we developed a warm earth-tone color scheme and a custom fiber optic star ceiling that gives the space an open, airy feel far beyond its footprint. Walls were finished with trim boxes and custom fabric panels to conceal the in-wall Triad speakers, keeping the design clean. Two JL Audio subwoofers were tucked into an adjacent room to save space, and the walls were decoupled for sound isolation. Custom Works AV handled the full speaker and AV integration.",
