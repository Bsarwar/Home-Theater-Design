...
const awards = [
  ...
  },
  {
    ...
    year: "2022",
    description: "Starting from the bare bones of an unfinished room, we devised a plan to transform the space — carefully navigating HVAC ductwork, a sump pump, and other mechanicals, ultimately flipping the room's original orientation to conceal all equipment behind a new wall. The client ordered custom home theater furniture, and we used its warm, cozy palette as the design anchor, matching it with beautiful trim work and custom fabric wall panels throughout. Our systems integration partner Custom Works AV concealed recessed Triad speakers seamlessly within the panels, then rounded out the audio with two JL Audio subwoofers and an 11-channel Marantz AV receiver. A 120-inch Screen Innovations Zero Edge Slate screen and Sony 4K projector complete the picture — delivering the classy, well-appointed home theater of the owners' dreams.",
