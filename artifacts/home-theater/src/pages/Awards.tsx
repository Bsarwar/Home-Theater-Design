...
const awards = [
  ...
  },
  {
    ...
    year: "2024",
    description: <>Two lifelong admirers of the legendary Disney film <em>20,000 Leagues Under the Sea</em> came to us with a singular vision: build them a theater that put them aboard the Nautilus. Our woodworking partner Robert Baden Woodwork took the lead on the room's aesthetic, carefully crafting every surface and architectural detail to give the space a genuine submarine feel — dark, atmospheric, and unmistakably Captain Nemo's domain. Custom Works AV joined the project as our integration partner, concealing all technology seamlessly within the themed environment so that not a speaker grille or projector mount breaks the illusion. The result is a space that is as visually captivating as it is sonically breathtaking.</>,
