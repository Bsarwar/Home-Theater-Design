...
const processSteps = [
  ...
  { num: "03", title: "Design", desc: "We work with our client to design the aesthetics of the room and create a material list based on the tailored specifications of the space." },
