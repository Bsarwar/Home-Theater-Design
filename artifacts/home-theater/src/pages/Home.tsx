...
const processSteps = [
  ...
  { num: "04", title: "Construction", desc: "Room construction starts from framing to finishing. We coordinate with the AV company at each phase to prewire the room and install all in-wall speakers." },
    ...
    <div className="bg-[hsl(220_15%_7%)]">
      ...
      <section className="bg-[hsl(220_15%_10%)] border-y border-[hsl(220_15%_16%)]">
        <div className="max-w-5xl mx-auto px-6 py-8 flex items-center justify-center gap-6 md:gap-10">
          ...
          {/* Right image */}
          <div className="shrink-0 w-20 h-20 overflow-hidden" style={{ mixBlendMode: "screen" }}>
            <img src={laurelRightImg} alt="" className="w-full h-full object-contain" style={{ filter: "brightness(0.45)" }} />
          </div>
