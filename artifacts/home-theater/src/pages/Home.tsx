...
const projects = [
  { title: "Palm Beach Estate", type: "Private Cinema", location: "Palm Beach, FL", gradient: "from-slate-900 via-blue-950 to-slate-900" },
    ...
    <div className="bg-[hsl(225_50%_7%)]">
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pt-28 pb-32 w-full">
          <div className="max-w-3xl">
            <div className={`transition-all duration-1000 ${heroReady ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}>
              <div className="flex items-center gap-3 mb-8">
                ...
                <span className="text-[hsl(210_25%_72%)] text-xs tracking-[0.3em] uppercase font-medium">Since 2005</span>
              </div>
              <h1 className="font-serif text-6xl md:text-8xl font-light leading-[0.9] text-white mb-8 drop-shadow-2xl">
                Cinema.<br />
                <span className="italic text-[hsl(210_25%_72%)]">Perfected.</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Link href="/contact" data-testid="hero-cta-contact">
                  <span className="inline-flex items-center gap-3 px-8 py-4 border border-white/30 text-white text-sm tracking-[0.15em] uppercase font-medium cursor-pointer hover:border-[hsl(210_25%_72%)] hover:text-[hsl(210_25%_72%)] transition-colors duration-300">
                    Get a Quote
                  </span>
                </Link>
              </div>
          ...
          <div className={`absolute bottom-10 left-6 right-6 flex items-end justify-between transition-all duration-1000 delay-500 ${heroReady ? "opacity-100" : "opacity-0"}`}>
              ...
              <div className="flex gap-2">
                {heroSlides.map((_, i) => (
                  <button
                    ...
                    onClick={() => goToSlide(i)}
                    className={`transition-all duration-300 ${i === slide ? "w-8 h-1 bg-[hsl(210_25%_72%)]" : "w-4 h-1 bg-white/30 hover:bg-white/60"}`}
            ...
            <div className="flex gap-2">
              <button
                ...
                onClick={prevSlideFn}
                className="w-10 h-10 border border-white/20 flex items-center justify-center text-white/60 hover:border-[hsl(210_25%_72%)] hover:text-[hsl(210_25%_72%)] transition-colors duration-200"
          ...
          <div className={`absolute bottom-10 left-1/2 -translate-x-1/2 transition-all duration-1000 delay-700 ${heroReady ? "opacity-100" : "opacity-0"}`}>
            <ChevronDown className="text-[hsl(210_25%_72%)] animate-bounce" size={24} />
          </div>
        </div>

        <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[hsl(210_25%_72%/0.4)] to-transparent" />
      </section>

      {/* STATS BAR */}
      <section className="bg-[hsl(225_45%_10%)] border-y border-[hsl(225_35%_16%)]">
          ...
          {[
            ...
            <FadeIn key={stat.label} delay={i * 100}>
              <div className="text-center" data-testid={`stat-${i}`}>
                <div className="font-serif text-4xl text-[hsl(210_25%_72%)] mb-1">{stat.value}</div>
                <div className="text-[hsl(210_10%_55%)] text-xs tracking-[0.15em] uppercase">{stat.label}</div>
              </div>
            </FadeIn>
          ))}
        </div>
      ...
      <section className="py-24 md:py-36" data-testid="services-section">
        <div className="max-w-7xl mx-auto px-6">
          <FadeIn>
            <div className="max-w-2xl mb-20">
              <div className="flex items-center gap-3 mb-6">
                <div className="h-px w-12 bg-[hsl(210_25%_72%)]" />
                <span className="text-[hsl(210_25%_72%)] text-xs tracking-[0.3em] uppercase">What We Do</span>
              </div>
              <h2 className="font-serif text-5xl md:text-6xl font-light text-[hsl(210_15%_92%)] leading-tight">
                Engineering<br />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-[hsl(225_35%_14%)]">
            {services.map((svc, i) => {
              const Icon = svc.icon;
              return (
                <FadeIn key={svc.title} delay={i * 80}>
                  <div
                    ...
                    className="bg-[hsl(225_50%_7%)] p-8 group hover:bg-[hsl(225_45%_10%)] transition-colors duration-300"
                  >
                    <Icon className="text-[hsl(210_25%_72%)] mb-6" size={24} strokeWidth={1.5} />
                    <h3 className="font-serif text-xl text-[hsl(210_15%_90%)] mb-3 group-hover:text-[hsl(210_25%_72%)] transition-colors duration-300">{svc.title}</h3>
                    <p className="text-[hsl(210_10%_55%)] text-sm leading-relaxed">{svc.desc}</p>
                  </div>
                </FadeIn>
              );
            })}
          ...
          <FadeIn delay={400} className="mt-10">
            <Link href="/services" data-testid="services-learn-more">
              <span className="inline-flex items-center gap-2 text-[hsl(210_25%_72%)] text-sm tracking-[0.15em] uppercase font-medium cursor-pointer hover:gap-4 transition-all duration-300">
      ...
      {/* FEATURED PROJECTS */}
      <section className="py-24 md:py-36 bg-[hsl(225_50%_5%)]" data-testid="projects-section">
        <div className="max-w-7xl mx-auto px-6">
          <FadeIn>
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-6">
              <div>
                <div className="flex items-center gap-3 mb-6">
                  <div className="h-px w-12 bg-[hsl(210_25%_72%)]" />
                  <span className="text-[hsl(210_25%_72%)] text-xs tracking-[0.3em] uppercase">Our Portfolio</span>
                </div>
                <h2 className="font-serif text-5xl md:text-6xl font-light text-[hsl(210_15%_92%)] leading-tight">
                  Featured<br />
                ...
                >
                  ...
                  >
                    <div className="text-center p-8">
                      <div className="w-16 h-16 border border-[hsl(210_25%_72%/0.4)] flex items-center justify-center mx-auto mb-4">
                        <Play className="text-[hsl(210_25%_72%)]" size={20} />
                      </div>
                      <div className="font-serif text-2xl text-[hsl(210_15%_90%)] opacity-60">{project.title}</div>
                    </div>
                  </div>
                  <div className="absolute inset-0 bg-gradient-to-t from-[hsl(225_50%_5%)] via-transparent to-transparent opacity-80" />
                  <div className="absolute bottom-0 left-0 right-0 p-6 translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                    <div className="text-[hsl(210_25%_72%)] text-xs tracking-[0.2em] uppercase mb-1">{project.type}</div>
                    <div className="font-serif text-xl text-[hsl(210_15%_92%)]">{project.title}</div>
                    <div className="text-[hsl(210_10%_55%)] text-xs mt-1">{project.location}</div>
                  </div>
                </div>
              </FadeIn>
            ))}
      ...
      {/* BRAND PARTNERS */}
      <section className="py-16 border-y border-[hsl(225_35%_14%)]">
        <div className="max-w-7xl mx-auto px-6">
          <FadeIn>
            <p className="text-center text-[hsl(210_10%_45%)] text-xs tracking-[0.3em] uppercase mb-10">Our Trusted Partners</p>
          </FadeIn>
            ...
            {brands.map((brand, i) => (
              <FadeIn key={brand} delay={i * 50}>
                <span
                  ...
                  className="text-[hsl(210_10%_38%)] text-sm tracking-[0.2em] uppercase font-medium hover:text-[hsl(210_25%_72%)] transition-colors duration-300 cursor-default"
                >
                  {brand}
                </span>
              </FadeIn>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <FadeIn>
            <div className="max-w-2xl mb-20">
              <div className="flex items-center gap-3 mb-6">
                <div className="h-px w-12 bg-[hsl(210_25%_72%)]" />
                <span className="text-[hsl(210_25%_72%)] text-xs tracking-[0.3em] uppercase">Our Process</span>
              </div>
              <h2 className="font-serif text-5xl md:text-6xl font-light text-[hsl(210_15%_92%)] leading-tight">
                From Vision<br />
              ...
              <FadeIn key={step.num} delay={i * 100}>
                <div data-testid={`process-step-${i}`} className="relative">
                  {i < processSteps.length - 1 && (
                    <div className="hidden md:block absolute top-8 left-full w-full h-px bg-gradient-to-r from-[hsl(210_25%_72%/0.4)] to-transparent" />
                  )}
                  <div className="text-[hsl(210_25%_72%)] font-serif text-5xl font-light mb-4">{step.num}</div>
                  <h3 className="text-[hsl(210_15%_90%)] font-medium text-sm tracking-wide uppercase mb-3">{step.title}</h3>
                  <p className="text-[hsl(210_10%_55%)] text-sm leading-relaxed">{step.desc}</p>
                </div>
              </FadeIn>
            ))}
          </div>
      ...
      {/* TESTIMONIALS */}
      <section className="py-24 md:py-36 bg-[hsl(225_50%_5%)]" data-testid="testimonials-section">
        <div className="max-w-7xl mx-auto px-6">
          <FadeIn>
            <div className="max-w-2xl mb-20">
              <div className="flex items-center gap-3 mb-6">
                <div className="h-px w-12 bg-[hsl(210_25%_72%)]" />
                <span className="text-[hsl(210_25%_72%)] text-xs tracking-[0.3em] uppercase">Client Stories</span>
              </div>
              <h2 className="font-serif text-5xl md:text-6xl font-light text-[hsl(210_15%_92%)] leading-tight">
                What Our<br />
            ...
            {testimonials.map((t, i) => (
              <FadeIn key={t.name} delay={i * 120}>
                <div
                  ...
                  className="border border-[hsl(225_35%_16%)] p-8 hover:border-[hsl(210_25%_72%/0.4)] transition-colors duration-300"
                >
                  <div className="flex gap-1 mb-6">
                    {[...Array(t.rating)].map((_, si) => (
                      <Star key={si} size={12} className="text-[hsl(210_25%_72%)] fill-current" />
                    ))}
                  </div>
                  <p className="font-serif text-lg text-[hsl(210_15%_82%)] leading-relaxed italic mb-6">"{t.quote}"</p>
                  <div>
                    <div className="text-[hsl(210_15%_90%)] text-sm font-medium">{t.name}</div>
                    <div className="text-[hsl(210_10%_50%)] text-xs mt-0.5">{t.title}</div>
                  </div>
                </div>
              </FadeIn>
            ))}
      ...
      <section className="py-24 md:py-36 relative overflow-hidden" data-testid="cta-section">
        <div className="absolute inset-0" style={{ background: "radial-gradient(ellipse at center, hsl(210 25% 72% / 0.08) 0%, transparent 70%)" }} />
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <FadeIn>
            <div className="flex items-center justify-center gap-3 mb-8">
              <div className="h-px w-12 bg-[hsl(210_25%_72%)]" />
              <span className="text-[hsl(210_25%_72%)] text-xs tracking-[0.3em] uppercase">Begin Your Journey</span>
              <div className="h-px w-12 bg-[hsl(210_25%_72%)]" />
            </div>
            <h2 className="font-serif text-5xl md:text-7xl font-light text-[hsl(210_15%_92%)] leading-tight mb-8">
              Ready to Experience<br />
              <span className="italic text-[hsl(210_25%_72%)]">Pure Cinema?</span>
            </h2>
            <p className="text-[hsl(210_10%_60%)] text-lg max-w-xl mx-auto mb-12 leading-relaxed">
            ...
            <Link href="/contact" data-testid="cta-get-quote">
              <span className="inline-flex items-center gap-3 px-10 py-5 bg-[hsl(210_25%_72%)] text-[hsl(225_50%_7%)] text-sm tracking-[0.2em] uppercase font-bold cursor-pointer hover:bg-[hsl(210_25%_82%)] transition-colors duration-300 shadow-2xl">
